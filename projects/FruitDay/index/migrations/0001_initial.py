# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-09-07 07:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='cartinfo',
            name='goods_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.Goods', verbose_name='good_id'),
        ),
        migrations.AddField(
            model_name='cartinfo',
            name='user_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.Users', verbose_name='user_id'),
        ),
    ]
